...
#define DISABLE_INTERRUPTS()    __set_PRIMASK(1)//NVIC_SETPRIMASK();
#define ENABLE_INTERRUPTS()     __set_PRIMASK(0)//NVIC_RESETPRIMASK();
...
#define SCHEDULER_WAKEUP()                  //--?? yadong wan EXTI->SWIER |= EXTI_Line1;
...
static const uint8_t infoBoardname[]        = "OPENMOTESTM32L4";
static const uint8_t infouCName[]           = "STM32L476";
