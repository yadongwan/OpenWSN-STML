...
This was done on 2015-01-19 16:43:52.704000.
*/
/**
DO NOT EDIT DIRECTLY!!
...
This was done on 2015-01-19 16:35:26.096000.
*/
/**
...
typedef void (*opentimers_cbt)(OpenMote* self, OpenMote* self);
...
void opentimers_init(OpenMote* self, OpenMote* self);
opentimer_id_t opentimers_start(OpenMote* self, OpenMote* self, uint32_t       duration,
                                timer_type_t   type,
                                time_type_t timetype,
                                opentimers_cbt callback);
void opentimers_setPeriod(OpenMote* self, OpenMote* self, opentimer_id_t id,time_type_t timetype, uint32_t       newPeriod);
void opentimers_stop(OpenMote* self, OpenMote* self, opentimer_id_t id);
void opentimers_restart(OpenMote* self, OpenMote* self, opentimer_id_t id);

void opentimers_sleepTimeCompesation(OpenMote* self, OpenMote* self, uint16_t sleepTime);
